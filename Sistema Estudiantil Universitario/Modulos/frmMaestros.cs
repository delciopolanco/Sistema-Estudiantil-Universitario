...
namespace Sistema_Estudiantil_Universitario.Modulos
{
    public partial class frmMaestros : Form
    {
        ...
        private void frmMaestros_FormClosed(object sender, FormClosedEventArgs e)
        {
            frmPrincipal.maestros = null;
        }
        ...
        private void frmMaestros_Load(object sender, EventArgs e)
        {
            ...
            llenarDataGrid(DocentesBD.Filtrar(TipoDocente.Maestro));
        ...
        private void txtIdHorario_SelectedValueChanged(object sender, EventArgs e)
        {
        ...
        private void btnBuscar_Click(object sender, EventArgs e)
        {
            ...
            {
                llenarDataGrid(DocentesBD.Filtrar(txtBuscar.Text.Trim(), TipoDocente.Maestro));
            }
            else
            {
                llenarDataGrid(DocentesBD.Filtrar(TipoDocente.Maestro));
